    ...
    (() => {
        ...
        let gotoblock_gotoBlock = (targetBlock, noHeader = false, speed = 500, offsetTop = 0) => {
            ...
            if (targetBlockElement) {
                ...
                functions_FLS(`[gotoBlock]: Юху...Едем до ${targetBlock}`);
            } else functions_FLS(`[gotoBlock]: Ой... Нет такого блока на странице: ${targetBlock}`);
        };
        ...
        function initSliders() {
            if (document.querySelector(".team__mobile-slider")) new core(".team__mobile-slider", {
                observer: true,
                observeParents: true,
                spaceBetween: 16,
                breakpoints: {
