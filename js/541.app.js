...
(self["webpackChunkplatinum"] = self["webpackChunkplatinum"] || []).push([ [ 541 ], {
    541: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
        ...
        function A11y({swiper, extendParams, on}) {
            ...
            const init = () => {
                const params = swiper.params.a11y;
                if (swiper.isElement) swiper.el.shadowEl.append(liveRegion); else swiper.el.append(liveRegion);
